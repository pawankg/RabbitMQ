...
# Exclusive=True, so that the queue will be deleted automatically on deleting the subscriber
...
# Created two bindings since alarm raiser has to work for both Errors and warnings
